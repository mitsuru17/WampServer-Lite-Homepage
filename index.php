...
$langues = array(
	'en' => array(
		...
		'titrePage' => 'Tools',
		'txtProjet' => 'Proyectos',
		'txtNoProjet' => 'No hay proyectos.<br />Para crear uno nuevo, solo cree una carpeta en \'www\'.',
		'txtAlias' => 'Alias',
		'txtNoAlias' => 'No hay Alias.<br />Para crear uno nuevo, use el menu de WAMPSERVER.',
...
<body>
	...
	<div class="content">
		<div>
			<em>{$langues[$langue]['versa']}</em> ${apacheVersion} |
		</div>
		<div>
			<em>{$langues[$langue]['versp']}</em> ${phpVersion} |
		</div>
		<div>
			<em>{$langues[$langue]['server']}</em> ${server_software} |
		</div>
		<div>
			<em>{$langues[$langue]['versm']}</em> ${mysqlVersion} | 
		</div>
	</div>
